...
This issue tracker is only for technical issues related to kotod.

General Koto questions and/or support requests and are best directed to the [Koto Forums](https://discourse.koto.cash).
...
### The version of Koto you were using:
Run `kotod --version` to find out
