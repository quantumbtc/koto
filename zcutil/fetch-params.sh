...
SPROUT_URL="http://dl.ko-to.org:8080"
...
Failed to fetch the Koto zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
Koto - fetch-params.sh

This script will fetch the Koto zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Koto zkSNARK parameters. Note that it is
