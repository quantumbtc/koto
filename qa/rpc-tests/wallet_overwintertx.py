...
class WalletOverwinterTxTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Node 0 shields to Node 2, a coinbase utxo of value 97.0 less default fee
        zsendamount = Decimal('97.0') - DEFAULT_FEE
        recipients = []
        ...
        # Node 0 shields to Node 3, a coinbase utxo of value 97.0 less default fee
        zsendamount = Decimal('97.0') - DEFAULT_FEE
        recipients = []
        ...
        assert_equal(result["version"], 4)
        assert_equal(result["overwintered"], True)
        assert_equal(result["versiongroupid"], "9023e50a")
        result = self.nodes[0].getrawtransaction(txid_zsendmany, 1)
        assert_equal(result["version"], 4)
        assert_equal(result["overwintered"], True)
        assert_equal(result["versiongroupid"], "9023e50a")
