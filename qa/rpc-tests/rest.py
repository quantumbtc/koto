...
class RESTTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(encode(response_str, "hex_codec")[0:224], response_hex_str[0:224])
        ...
        assert_equal(encode(response_header_str, "hex-codec")[0:224], response_header_hex_str[0:224])
