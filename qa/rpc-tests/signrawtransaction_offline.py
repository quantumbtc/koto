...
class SignOfflineTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        sign_inputs = [{'txid': txid, 'vout': 0, 'scriptPubKey': scriptpubkey, 'amount': 3920000*0.97}]

        create_hex = self.nodes[0].createrawtransaction(create_inputs, {taddr: Decimal('3802400.0') - DEFAULT_FEE})
