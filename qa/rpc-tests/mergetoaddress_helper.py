...
class MergeToAddressHelper:
    ...
    def run_test(self, test):
        ...
        assert_equal(test.nodes[0].z_getbalance(myzaddr), Decimal('3802778.0') - DEFAULT_FEE)
        ...
        assert_equal(test.nodes[0].z_getbalance(myzaddr2), Decimal('3802778.0') - DEFAULT_FEE)
        ...
        assert_equal(test.nodes[0].getbalance(), Decimal('3803079.0') - DEFAULT_FEE)
        assert_equal(test.nodes[0].z_getbalance(do_not_shield_taddr), Decimal('10.0'))
        assert_equal(test.nodes[0].z_getbalance(mytaddr), Decimal('3803069.0') - DEFAULT_FEE)
        assert_equal(test.nodes[0].z_getbalance(myzaddr), 0)
        ...
        assert_equal(test.nodes[0].z_getbalance(myzaddr), 0)
        assert_equal(test.nodes[1].getbalance(), Decimal('3803855.0') - DEFAULT_FEE)
        assert_equal(test.nodes[1].z_getbalance(n1taddr), Decimal('3803079.0') - DEFAULT_FEE)
        assert_equal(test.nodes[2].getbalance(), 0)
