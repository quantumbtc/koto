...
class PaymentDisclosureTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Shield coinbase utxos from node 0 of value 3802691, default fee
        recipients = [{"address": myzaddr, "amount": Decimal('3802691.0') - DEFAULT_FEE}]
        ...
        result = self.nodes[0].z_validatepaymentdisclosure(pd)
        output_value_sum += Decimal(result["value"])
        assert_equal(output_value_sum, Decimal('3802691.0') - DEFAULT_FEE)
