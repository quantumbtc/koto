...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "koto.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "kotod.pid"));
...
{
    return "\n" +
           FormatParagraph(strprintf(_("In order to ensure you are adequately protecting your privacy when using Koto, please see <%s>."),
