...
static const unsigned int PRE_BLOSSOM_HALVING_INTERVAL = 1051200;
static const unsigned int PRE_BLOSSOM_REGTEST_HALVING_INTERVAL = 200;
...
struct Params {
     ...
     */
    int nFutureTimestampSoftForkHeight = 250;
