...
/** Interface to Koto wallet from Qt view code. */
...
private:
    ...
    CAmount cachedTBalance;
    CAmount cachedZBalance;
    CAmount cachedUnshielded;
...
Q_SIGNALS:
    // Signals that balance in wallet changed
    void balanceChanged(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
                        const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance,
                        const CAmount& t_balance, const CAmount& z_balance, const CAmount& coinbase);
