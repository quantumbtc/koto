...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(platformStyle->MultiColorIcon(":/images/overview"), tr("&Overview"), this);
    ...
    addressBookAction->setStatusTip(tr("View and manage the Koto address book"));
    addressBookAction->setToolTip(addressBookAction->statusTip());
    addressBookAction->setCheckable(true);
    addressBookAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(addressBookAction);

    addressBookMenuAction = new QAction(platformStyle->MultiColorIcon(":/images/addressbook1"), addressBookAction->text(), this);
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Koto address using transparent transactions"));
    sendCoinsAction->setToolTip(sendCoinsAction->statusTip());
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(sendCoinsAction);

    sendCoinsMenuAction = new QAction(platformStyle->MultiColorIcon(":/images/send"), sendCoinsAction->text(), this);
    sendCoinsMenuAction->setStatusTip(sendCoinsAction->statusTip());
    sendCoinsMenuAction->setToolTip(sendCoinsMenuAction->statusTip());

    sendZCoinsAction = new QAction(platformStyle->MultiColorIcon(":/images/send3"), tr("&Private Payment"), this);
    sendZCoinsAction->setStatusTip(tr("Send coins to a Koto address using private transacions"));
    ...
    sendZCoinsMenuAction = new QAction(platformStyle->MultiColorIcon(":/images/send3"), sendZCoinsAction->text(), this);
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and koto: URIs)"));
    receiveCoinsAction->setToolTip(receiveCoinsAction->statusTip());
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_4));
    tabGroup->addAction(receiveCoinsAction);

    receiveCoinsMenuAction = new QAction(platformStyle->MultiColorIcon(":/images/receive"), receiveCoinsAction->text(), this);
    receiveCoinsMenuAction->setStatusTip(receiveCoinsAction->statusTip());
    receiveCoinsMenuAction->setToolTip(receiveCoinsMenuAction->statusTip());

    UnspentAction = new QAction(platformStyle->MultiColorIcon(":/images/unspent"), tr("&Unspent"), this);
    ...
    UnspentMenuAction = new QAction(platformStyle->MultiColorIcon(":/images/unspent"), UnspentAction->text(), this);
    UnspentMenuAction->setStatusTip(UnspentAction->statusTip());
    UnspentMenuAction->setToolTip(UnspentMenuAction->statusTip());

    historyAction = new QAction(platformStyle->MultiColorIcon(":/images/transactions"), tr("&Transactions"), this);
    ...
    quitAction = new QAction(platformStyle->MultiColorIcon(":/images/exit"), tr("E&xit"), this);
    quitAction->setStatusTip(tr("Quit application"));
    quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
    quitAction->setMenuRole(QAction::QuitRole);
    aboutAction = new QAction(platformStyle->MultiColorIcon(":/images/about"), tr("&About %1").arg(tr(PACKAGE_NAME)), this);
    aboutAction->setStatusTip(tr("Show information about %1").arg(tr(PACKAGE_NAME)));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutAction->setEnabled(false);
    aboutQtAction = new QAction(platformStyle->MultiColorIcon(":/images/qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->MultiColorIcon(":/images/settings"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for %1").arg(tr(PACKAGE_NAME)));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    optionsAction->setEnabled(false);
    toggleHideAction = new QAction(platformStyle->MultiColorIcon(":/images/about"), tr("&Show / Hide"), this);
    ...
    backupWalletAction = new QAction(platformStyle->MultiColorIcon(":/images/backup"), tr("&Backup Wallet..."), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Koto addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->MultiColorIcon(":/images/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Koto addresses"));
    ...
    openAction->setStatusTip(tr("Open a koto: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->MultiColorIcon(":/images/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Koto command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    switch(count)
    {
    case 0: icon = ":/images/connect_0"; break;
    case 1: case 2: icon = ":/images/connect_1"; break;
    case 3: case 4: icon = ":/images/connect_2"; break;
    case 5: case 6: icon = ":/images/connect_3"; break;
    case 7: case 8: icon = ":/images/connect_4"; break;
    case 9: icon = ":/images/connect_5"; break;
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Koto network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate)
{
    ...
    if(secs < 90*60)
    {
        ...
        labelBlocksIcon->setPixmap(platformStyle->MultiColorIcon(":/images/synced").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
    ...
    else
    {
        ...
        if(count != prevBlocks)
        {
            labelBlocksIcon->setPixmap(platformStyle->MultiColorIcon(QString(
...
{
    QString strTitle = tr("Koto"); // default title
